...
Pod::Spec.new do |s|
  s.name             = 'JPTools'
  s.version          = '0.1.0'
  s.summary          = 'A short description of JPTools.'
...
TODO: Add long description of the pod here.
  ...
  s.author           = { 'jokepran@163.com' => 'wuchun_feng@queenchip.com' }
  s.source           = { :git => 'https://github.com/jokepran@163.com/JPTools.git', :tag => s.version.to_s }
